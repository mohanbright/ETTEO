...
import 'package:etteo_demo/pages/widgets/wizard/enter_part_information.dart';
...
class SupplyParts extends StatelessWidget {
  @override
                ...
                children: <Widget>[
                  ...
                  ButtonTheme(
                    ...
                    child: OutlineButton(
                      ...
                      onPressed: () {
                        /// Redirect to additional services
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (context) =>
