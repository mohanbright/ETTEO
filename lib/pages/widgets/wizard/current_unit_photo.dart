...
import 'package:etteo_demo/pages/widgets/wizard/current_dataplate_photo.dart';
...
class CurrentUnitPhoto extends StatefulWidget {
  @override
  _CurrentUnitPhotoState createState() => _CurrentUnitPhotoState();
}

class _CurrentUnitPhotoState extends State<CurrentUnitPhoto> {
  ...
  Future<void> createDocumentsFromAsset(List<Asset> docs) async {
    ...
    for (var doc in docs) {
      ...
      newDocument.documentType =
          _wizardBloc.defaultDocumentTypeCurrentUnit.documentTypeName;
      newDocument.documentTypeId =
          _wizardBloc.defaultDocumentTypeCurrentUnit.documentTypeId;
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Align(
                ...
                child: Text(
                  "Attach a photo of the current unit", //Concatenate the appropriate SERVICE name
            ...
            new Container(
              margin: EdgeInsets.only(bottom: screenAwareSize(20, 40, context)),
              child: Column(
